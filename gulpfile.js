...
gulp.task('compile:img', () => {
  return gulp.src(['client/**/*.{jpg,jpeg,png,gif}'])
...
gulp.watch('client/**/*.xml', ['compile:xml']);
gulp.watch('client/**/*.less', ['compile:less']);
gulp.watch('client/**/*.scss', ['compile:scss']);
gulp.watch('client/**/*.json', ['compile:json']);
gulp.watch('client/**/*.{jpe?g,png,gif}', ['compile:img']);
});
